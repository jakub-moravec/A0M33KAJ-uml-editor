...
var Map     = __webpack_require__(114)
  ...
  , store   = shared.store || (shared.store = new (__webpack_require__(117)));
...
if(__webpack_require__(6)){
  var LIBRARY             = __webpack_require__(32)
    ...
    , arrayCopyWithin     = __webpack_require__(91)
...
var _LifeLine = __webpack_require__(89);

var _LifeLine2 = _interopRequireDefault(_LifeLine);
...
var App = function () {
    ...
    _createClass(App, [{
        key: "addLifeLine",
        value: function addLifeLine(lifeLine) {
            ...
            if (lifeLine.order < this.maxLifeLines) {
                ...
                if (lifeLine.order < this.lifeLines.length) {
                    for (var i = lifeLine.order; i < this.lifeLines.length; i++) {
        ...
        key: "updateLifeLine",
        value: function updateLifeLine(lifeLine, form) {
            ...
            if (lifeLine.new !== true) {
                var newOrder = form.elements["order"].options[form.elements["order"].selectedIndex].value - 1;
        ...
        key: "deleteLifeLine",
        value: function deleteLifeLine(lifeLine) {
            var index = this.lifeLines.indexOf(lifeLine);

            // move order
            if (index != this.lifeLines.length - 1) {
                for (var i = index; i < this.lifeLines.length; i++) {
                    this.lifeLines[i].order--;
                }
            }
        ...
        value: function render() {
            ...
            var navigator = document.createElement("ol");

            var _loop = function _loop(i) {
                var lifeLine = _this.lifeLines[i];
                lifeLine.render();
        ...
        key: "renderLifeLineForm",
        value: function renderLifeLineForm(lifeLine) {

            var h = "<h2>Update LifeLine</h2>";
            var form = document.createElement("form");

            var inputNameLabel = document.createElement("label");
            ...
            if (lifeLine.new !== true) {
                ...
                order.name = "order";
                var endIndex = lifeLine.new === true ? this.lifeLines.length + 1 : this.lifeLines.length;
...
exports.ActionStereotype = undefined;
...
var ActionStereotype = exports.ActionStereotype = Object.freeze({ "synchronous": "synchronous", "asynchronous": "asynchronous" });

var Action = function () {
    function Action(beginning, source, target, name, stereotype) {
    ...
    _createClass(Action, [{
        key: "render",
        value: function render() {
            var width = Math.abs(this.source.lifeLine.order - this.target.lifeLine.order) * this.source.lifeLine.maxWidth;
            ...
            var removeBar = document.createElement("div");
        ...
        value: function handleDrop(event) {
            var diff = event.clientY - this.dragStartY;
            var newBeginning = this.beginning + diff;
...
var _Action = __webpack_require__(87);
...
var LifeBar = function () {
    function LifeBar(lifeLine, beginning, duration) {
    ...
    _createClass(LifeBar, [{
        key: 'createNewAction',
        value: function createNewAction() {
            if (this === _App.app.newActionEnd) {
                return;
            }
            var action = new _Action2.default(this.newActionBeginning, this, _App.app.newActionEnd, null, null);
            action.new = true;
            _App.app.newActionStart = null;
            _App.app.newActionEnd = null;
            this.renderActionForm(action);
        }
    }, {
        key: 'updateAction',
        value: function updateAction(action, form) {
            var newName = form.elements["name"].value;
            if (newName == "") {
                alert("Empty name not allowed!");
                return;
            ...
            var newStereotype = form.elements["stereotype"].options[form.elements["stereotype"].selectedIndex].value;
            var newStereotypeEl = null;
            if (newStereotype == "synchronous") {
                newStereotypeEl = _Action.ActionStereotype.synchronous;
            } else {
                newStereotypeEl = _Action.ActionStereotype.asynchronous;
            }
        ...
        key: 'renderActionForm',
        value: function renderActionForm(action) {

            var h = "<h2>Update Action</h2>";
            var form = document.createElement("form");
            ...
            var stereotypeLabel = document.createElement("label");
            stereotypeLabel.innerText = "Action stereotype:";
            form.appendChild(stereotypeLabel);

            var stereotype = document.createElement("select");
            stereotype.name = "stereotype";

            var sync = document.createElement("option");
            sync.value = _Action.ActionStereotype.synchronous;
            sync.innerText = _Action.ActionStereotype.synchronous;
            stereotype.appendChild(sync);

            var async = document.createElement("option");
            async.value = _Action.ActionStereotype.asynchronous;
            async.innerText = _Action.ActionStereotype.asynchronous;
            stereotype.appendChild(async);

            if (action.stereotype === _Action.ActionStereotype.synchronous) {
                sync.selected = true;
            } else if (action.stereotype === _Action.ActionStereotype.asynchronous) {
                async.selected = true;
            } else {
                sync.selected = true;
            }
            ...
            cancelButton.addEventListener("click", function (event) {
                while (_App.app.contextEl.firstChild) {
                    _App.app.contextEl.removeChild(_App.app.contextEl.firstChild);
                }
                event.preventDefault();
            }.bind(this));
            ...
            _App.app.contextEl.innerHTML = h;
            _App.app.contextEl.appendChild(form);
        }
    }, {
        key: 'render',
        value: function render(initialWidth, initialHeight) {
            ...
            bar.addEventListener("click", function (event) {
                if (event.target.classList.contains("bar")) {
                    ...
                    if ("undefined" == typeof _App.app.newActionStart || _App.app.newActionStart === null) {
                        _App.app.newActionStart = this;
                        var approxY = event.clientY - this.el.getBoundingClientRect.top;
                        approxY = Math.max(0, approxY);
                        approxY = Math.min(this.duration, approxY);
                        this.newActionBeginning = approxY;
                    } else {
                        _App.app.newActionEnd = this;
                        _App.app.newActionStart.createNewAction();
                    }
                }
            }.bind(this));
...
var _LifeBar = __webpack_require__(88);
...
var LifeLine = function () {
    function LifeLine(name, innerEl, order) {
    ...
    _createClass(LifeLine, [{
        key: "_getMaxEndBar",
        value: function _getMaxEndBar() {
            var maxBarEnd = 0;
            for (var i = 0; i < this.lineBars.length; i++) {
                var barEnd = this.lineBars[i].beginning + this.lineBars[i].duration;
                if (barEnd > maxBarEnd) {
                    maxBarEnd = barEnd;
                }
            }
        ...
        value: function addBar() {
            var beginning = this._getMaxEndBar() + this.initialBarOffset;
            if (beginning + this.initialBarDuration <= this.lineHeight) {
                this.lineBars.push(new _LifeBar2.default(this, beginning, this.initialBarDuration));
                _App.app.render();
            } else {
        ...
        key: "removeBar",
        value: function removeBar(beginning, duration) {
            for (var i = 0; i < this.lineBars.length; i++) {
        ...
        key: "render",
        value: function render() {
            var mainPosition = this.innerEl.getBoundingClientRect();
            ...
            lineHead.addEventListener("click", function () {
                _App.app.renderLifeLineForm(this);
            }.bind(this));
            ...
            this.lineHeight = _App.app.mainEl.offsetHeight - 150;
        ...
        key: "handleDrop",
        value: function handleDrop(event) {
            if ("undefined" != typeof this.draggedBar && this.draggedBar !== null && ("undefined" == typeof this.draggedBarResizer || this.draggedBarResizer === null) && ("undefined" == typeof _App.app.draggedAction || _App.app.draggedAction === null)) {
                var dragEnd = event.clientY;
                var newBeginning = this.draggedBar.beginning + dragEnd - this.draggedBar.dragStartY;
            ...
            if ("undefined" !== typeof this.draggedBarResizer && this.draggedBarResizer !== null) {
                var _dragEnd = event.clientY;
                var newDuration = this.draggedBarResizer.duration + _dragEnd - this.draggedBarResizer.dragStartY;
...
var lifeLine1 = new _LifeLine2.default("test1", _App.app.mainEl, 0);
var lifeLine2 = new _LifeLine2.default("test2", _App.app.mainEl, 1);
var lifeLine3 = new _LifeLine2.default("test3", _App.app.mainEl, 2);

_App.app.addLifeLine(lifeLine1);
_App.app.addLifeLine(lifeLine2);
_App.app.addLifeLine(lifeLine3);

var bar1 = new _LifeBar2.default(lifeLine1, 10, 60);
lifeLine1.lineBars = [bar1];
var bar2 = new _LifeBar2.default(lifeLine2, 30, 35);
lifeLine2.lineBars = [bar2];
var bar3 = new _LifeBar2.default(lifeLine3, 15, 20);
lifeLine3.lineBars = [bar3];
_App.app.render();

var action1 = new _Action2.default(10, bar1, bar3, "async", _Action.ActionStereotype.asynchronous);
var action2 = new _Action2.default(25, bar1, bar2, "sync", _Action.ActionStereotype.synchronous);
bar1.actions = [action1, action2];

var action3 = new _Action2.default(30, bar2, bar1, "reply", _Action.ActionStereotype.synchronous);
...
var $export  = __webpack_require__(0)
  , $entries = __webpack_require__(107)(true);
...
var $export        = __webpack_require__(0)
  , ownKeys        = __webpack_require__(108)
  , toIObject      = __webpack_require__(15)
  , gOPD           = __webpack_require__(16)
  , createProperty = __webpack_require__(61);
